...
import SuperTab from "./adminTabs/SuperTab";  // הוספנו את ה-SuperTab
  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case "overview":
        return <OverviewTab />;
      case "super":
        return <SuperTab />;  // הוספנו את ה-SuperTab כאן
      default:
        return null;
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 to-gray-900 text-white p-4">
      <div className="flex justify-between items-center flex-wrap gap-4 mb-6">
        ...
        <div className="w-full flex flex-wrap justify-center gap-2">
          ...
          <button onClick={() => setActiveTab("super")} className={`px-4 py-2 rounded text-sm ${activeTab === "super" ? "bg-blue-500" : "bg-blue-700 hover:bg-blue-800"}`}>
            💎 סופר
          </button>
        </div>
      </div>
